...
const exploreLinks = [
  { label: "Packages", href: "/explore/packages" },
  { label: "Bar Tenders", href: "/explore/bartenders" },
  { label: "Cakes & Sweets", href: "/explore/cakes" },
  { label: "Catering", href: "/explore/catering" },
  { label: "Decorations", href: "/explore/decorations" },
  { label: "Entertainment", href: "/explore/entertainment" },
  { label: "Event Planners", href: "/explore/planners" },
  { label: "Gifts & Invites", href: "/explore/gifts" },
  { label: "Limousines", href: "/explore/limousines" },
  { label: "Makeup Artists", href: "/explore/makeup" },
  { label: "Party Equipment", href: "/explore/equipment" },
  { label: "Party Wear", href: "/explore/partywear" },
  { label: "Photographers", href: "/explore/photographers" },
  { label: "Photo Booths", href: "/explore/photobooths" },
  { label: "Venues", href: "/explore/venues" },
  { label: "Yachts", href: "/explore/yachts" },
]
