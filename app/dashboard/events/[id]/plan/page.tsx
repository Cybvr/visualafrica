  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 pb-24">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Region / Locale</label>
          ...
          <div className="md:col-span-2 space-y-2 pt-4">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Planning Brief</label>
      ...
      <section className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-orange-50 text-orange-600 rounded-2xl flex items-center justify-center"><Eye size={24} /></div>
          <div>
            <h4 className="font-black text-slate-900">Show in Community Inspiration</h4>
            <p className="text-sm text-slate-500 font-medium">Other users can see your theme and vendor choices.</p>
          </div>
        </div>
        <button
