          ...
          <div className="flex items-center gap-2">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => updateStatus(activeChat.id, 'requested')}>
                  Mark as Requested
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => updateStatus(activeChat.id, 'sent')}>
                  Mark as Sent
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => updateStatus(activeChat.id, 'quoted')}>
                  Mark as Quoted
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => updateStatus(activeChat.id, 'negotiating')}>
                  Mark as Negotiating
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => updateStatus(activeChat.id, 'booked')}>
                  Mark as Booked
                </DropdownMenuItem>
                <DropdownMenuItem
