...
const HostSettingsPage = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-10 pb-20">
            <div>
                <h2 className="text-4xl font-serif font-black tracking-tight text-slate-900">Settings</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="md:col-span-3">
                    <div className="bg-white border border-slate-100 rounded-[3rem] p-10 shadow-sm min-h-[500px] animate-in fade-in slide-in-from-bottom-4 duration-500">
                        {activeTab === 'Profile' && (
                            <div className="space-y-10">
                                <div>
                                    <h3 className="text-2xl font-serif font-black text-slate-900 mb-2">Personal Information</h3>
                                    <p className="text-sm text-slate-400 font-medium">Update your photo and personal details here.</p>
                                </div>
                                ...
                                <div className="flex items-center gap-6 pb-8 border-b border-slate-50">
                                    ...
                                    <div className="space-y-2">
                                        <button className="px-4 py-2 bg-slate-900 text-white text-xs font-black rounded-full hover:bg-slate-800 transition-all">
                                            Change Photo
                                        </button>
                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">JPG, GIF or PNG. 1MB Max.</p>
                                    </div>
                                </div>
                        ...
                        {activeTab !== 'Profile' && (
                            <div className="h-full flex flex-col items-center justify-center text-center space-y-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-serif font-black text-slate-900">{activeTab} Settings</h3>
