  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold tracking-tight text-slate-900">Guest Portal</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
            ...
            <button className="w-full mt-6 py-3 border border-slate-100 text-slate-500 font-bold text-sm rounded-2xl hover:bg-slate-50 transition-colors">
              Load more guests
            </button>
          </div>
        </div>
