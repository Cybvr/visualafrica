      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-10 rounded-[3rem] border border-border shadow-sm">
          <div className="space-y-2">
            ...
            <input type="text" defaultValue={eventData.name} className="w-full bg-slate-50 border-none px-6 py-4 rounded-2xl text-foreground font-bold focus:ring-2 focus:ring-primary outline-none transition-all" />
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Region / Locale</label>
            <input type="text" defaultValue={eventData.location} className="w-full bg-slate-50 border-none px-6 py-4 rounded-2xl text-foreground font-bold focus:ring-2 focus:ring-primary outline-none transition-all" />
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Start</label>
            <input type="date" defaultValue={eventData.startDate} className="w-full bg-slate-50 border-none px-6 py-4 rounded-2xl text-foreground font-bold focus:ring-2 focus:ring-primary outline-none transition-all" />
          </div>
          <div className="space-y-2">
            <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">End</label>
            <input type="date" defaultValue={eventData.endDate} className="w-full bg-slate-50 border-none px-6 py-4 rounded-2xl text-foreground font-bold focus:ring-2 focus:ring-primary outline-none transition-all" />
          </div>
          <div className="md:col-span-2 space-y-2 pt-4">
            <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Planning Brief</label>
            <textarea rows={4} defaultValue={eventData.description} className="w-full bg-slate-50 border-none px-6 py-4 rounded-2xl text-foreground font-medium focus:ring-2 focus:ring-primary outline-none resize-none" />
          </div>
        </div>
      </section>
