...
export default function BlogDetailPage() {
    ...
    if (!post) {
        return (
            <div className="max-w-3xl mx-auto py-20 text-center space-y-4">
                ...
                <Link href="/dashboard/hosts/diy-content" className="inline-flex items-center gap-2 text-orange-600 font-bold">
    ...
    return (
        <div className="max-w-6xl mx-auto pb-20">
            <Link href="/dashboard/hosts/diy-content" className="inline-flex items-center gap-2 text-sm font-bold text-slate-400 hover:text-slate-900 transition-colors mb-10">
                <ArrowLeft size={16} />
                Back to Resources
            </Link>
