...
export const vendors: Vendor[] = [
  {
    ...
    vendor: { name: "Qrated Event", logo: "", slug: "qrated-event" },
    whatsIncluded: ["Private terrace", "Luxury decor", "Photography"],
    services: ["Event Planning"],
    about: "Specialists in luxury experiences.",
  ...
  {
    id: "v-catering-1",
    slug: "gourmet-flavors-nigeria",
    name: "Gourmet Flavors Nigeria",
    categories: ["Catering"],
    ...
    gallery: [],
    vendor: { name: "Gourmet Flavorz", logo: "", slug: "gourmet-flavors" },
  ...
  },
  {
    ...
    gallery: [],
    vendor: { name: "Lagos Lens", logo: "", slug: "lagos-lens" },
  ...
  },
  {
    ...
    gallery: [],
    vendor: { name: "Glam by Titi", logo: "", slug: "glam-titi" },
