...
export function HolidayEscapeCard({ className, onClick }: { className?: string; onClick?: () => void }) {
    return (
        <div
            onClick={onClick}
            className={cn(
                "flex items-center gap-3 p-2 bg-white rounded-2xl border border-gray-200 shadow-sm max-w-[340px] w-full transition-all hover:shadow-md cursor-pointer active:scale-[0.98]",
                className
            )}
        >
            ...
            <div className="flex flex-col text-left justify-center overflow-hidden">
                ...
                <p className="text-[#666] text-[12px] leading-tight line-clamp-2">
