...
import { Search, Send, MapPin, ChevronDown } from 'lucide-react';
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
            ...
            <div className="w-full md:w-80 border-r border-border flex flex-col">
                <div className="p-6 border-b border-border/50">
                    ...
                    <div className="relative">
                        <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-foreground" size={16} />
                        <Input type="text" placeholder="Search chats..." className="w-full pl-10 pr-4 py-2  border-none rounded-2xl text-sm" />
                    </div>
                </div>
            ...
            <div className="flex-1 flex flex-col bg-secondary/20">
                ...
                <div className="p-6 bg-card border-t border-border/50">
                    <div className="flex gap-4">
                        <Textarea placeholder="Type your response..." className="flex-1 px-6 py-4 border-none rounded-[2rem] resize-none min-h-[56px] max-h-[120px] font-medium" />
