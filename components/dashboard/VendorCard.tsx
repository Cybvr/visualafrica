  ...
  return (
    <div className="bg-white rounded-[2rem] overflow-hidden border border-slate-100 hover:shadow-2xl hover:shadow-orange-600/5 transition-all group cursor-pointer flex flex-col h-full relative">
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <button
          onClick={toggleLike}
          className={`absolute top-4 right-4 p-2 rounded-full backdrop-blur-md transition-all ${isLiked ? 'bg-orange-600 text-white' : 'bg-white/80 text-slate-400 hover:text-orange-600'
            }`}
        >
